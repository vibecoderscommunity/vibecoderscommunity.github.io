...
- Fonts (Google Fonts): Silkscreen 700 (pixel display/wordmark), Handjet 600/700 (section headings), JetBrains Mono (body/UI). Body line-height 1.65.
...
- Flavor chip "RECAP"; Handjet H1 (event title); muted mono meta line
